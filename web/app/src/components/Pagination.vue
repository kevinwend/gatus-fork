<template>
  <div class="mt-3 flex">
    <div class="flex-1">
      <button v-if="currentPage < 6480" @click="nextPage" class="bg-gray-100 hover:bg-gray-200 text-gray-500 border border-gray-200 px-2 rounded font-mono dark:bg-gray-700 dark:text-gray-200 dark:border-gray-500 dark:hover:bg-gray-600">&lt;</button>
    </div>
